...
public interface TrainRepository extends MongoRepository<Train, String> {
     ...
     * Complex query to find trains that have both source and destination in their route
     */
    @Query("{ " +
           "'routes': { " +
     ...
     * This would require additional logic in service layer to calculate actual travel time
     */
    @Query("{ " +
           "'routes': { " +
           "  '$elemMatch': { 'stationCode': ?0 } " +
