...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    private void seedStations() {
        ...
        List<Station> stations = Arrays.asList(
            ...
            new Station("LTT", "Lokmanya Tilak Terminus", "Mumbai", "Maharashtra", "Central Railway", 19.0669, 72.9028),
            ...
            // Bangalore Region
            new Station("SBC", "Bengaluru City Junction", "Bengaluru", "Karnataka", "South Western Railway", 12.9716, 77.5946),
            new Station("YPR", "Yesvantpur Junction", "Bengaluru", "Karnataka", "South Western Railway", 13.0288, 77.5302),
            
            // Hyderabad Region
            new Station("SC", "Secunderabad Junction", "Hyderabad", "Telangana", "South Central Railway", 17.4399, 78.5011),
            new Station("HYB", "Hyderabad Deccan", "Hyderabad", "Telangana", "South Central Railway", 17.3850, 78.4867),
            ...
            new Station("LKO", "Lucknow Charbagh", "Lucknow", "Uttar Pradesh", "Northern Railway", 26.8467, 80.9462),
            ...
            new Station("TPTY", "Tirupati", "Tirupati", "Andhra Pradesh", "South Central Railway", 13.6288, 79.4192),
            new Station("CBE", "Coimbatore Junction", "Coimbatore", "Tamil Nadu", "Southern Railway", 11.0168, 76.9558),
            new Station("TVC", "Thiruvananthapuram Central", "Thiruvananthapuram", "Kerala", "Southern Railway", 8.4875, 76.9525),
            ...
            new Station("VSKP", "Visakhapatnam Junction", "Visakhapatnam", "Andhra Pradesh", "East Coast Railway", 17.7231, 83.3219),
            ...
            new Station("GWL", "Gwalior Junction", "Gwalior", "Madhya Pradesh", "North Central Railway", 26.2183, 78.1828),
            new Station("JBP", "Jabalpur Junction", "Jabalpur", "Madhya Pradesh", "West Central Railway", 23.1815, 79.9864),
            new Station("BPL", "Bhopal Junction", "Bhopal", "Madhya Pradesh", "West Central Railway", 23.2599, 77.4126),
            new Station("UJN", "Ujjain Junction", "Ujjain", "Madhya Pradesh", "West Central Railway", 23.1765, 75.7885),
            new Station("AGC", "Agra Cantt", "Agra", "Uttar Pradesh", "North Central Railway", 27.1767, 78.0081),
            new Station("CNB", "Kanpur Central", "Kanpur", "Uttar Pradesh", "North Central Railway", 26.4499, 80.3319),
            new Station("GKP", "Gorakhpur Junction", "Gorakhpur", "Uttar Pradesh", "North Eastern Railway", 26.7606, 83.3732),
            new Station("BSB", "Varanasi Junction", "Varanasi", "Uttar Pradesh", "North Eastern Railway", 25.3176, 82.9739),
            new Station("ALD", "Allahabad Junction", "Prayagraj", "Uttar Pradesh", "North Central Railway", 25.4358, 81.8463),
    ...
    private List<Train> createTrainData() {
        ...
        duronto.setRoutes(Arrays.asList(
            ...
            createRoute("DDU", "Pandit Deen Dayal Upadhyaya Junction", LocalTime.of(5, 55), LocalTime.of(6, 0), 1186, 6),
