  ...
  const features = [
    {
      ...
      title: 'Smart Search',
      description: 'Find trains with intelligent search and real-time availability',
      action: () => navigate('/search')
    },
    {
      icon: <DirectionsRailway sx={{ fontSize: 40 }} />,
      title: 'Live Tracking',
      description: 'Track your train status with real-time updates and notifications',
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              <Box sx={{ textAlign: { xs: 'center', md: 'left' } }}>
                ...
                <Typography variant="h2" gutterBottom fontWeight="bold" sx={{ fontSize: { xs: '2.5rem', md: '3.5rem' } }}>
                  Next Generation Railway Booking
                </Typography>
                
                <Typography variant="h5" sx={{ mb: 4, opacity: 0.9, fontWeight: 300 }}>
                  Experience seamless train bookings with real-time updates, smart search, and secure payments
                </Typography>
        ...
        <Container maxWidth="md">
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="h6" sx={{ mb: 4, opacity: 0.9 }}>
              Join millions of satisfied customers and experience the future of train booking
            </Typography>
            <Button
              variant="contained"
              size="large"
              onClick={() => isAuthenticated ? navigate('/search') : navigate('/login')}
              sx={{
                bgcolor: 'white',
