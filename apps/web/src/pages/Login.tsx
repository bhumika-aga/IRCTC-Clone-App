...
import { CheckCircle, Email, Security } from "@mui/icons-material";
import {
  Alert,
  Box,
  Button,
...
export function Login() {
  ...
  const [, setOtpSentTime] = useState<Date | null>(null);
              ...
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  <TextField
                    ...
                    helperText={
                      otpRequestForm.formState.errors.email?.message as string
                    }
                    InputProps={{
                      startAdornment: (
                ...
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    helperText={
                      otpRequestForm.formState.errors.firstName
                        ?.message as string
                    }
                  />
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField
                    ...
                    helperText={
                      otpRequestForm.formState.errors.lastName
                        ?.message as string
                    }
                  />
                </Grid>
